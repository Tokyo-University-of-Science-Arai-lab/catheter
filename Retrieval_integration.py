...
from detection.pro_handbook.sam_py_demo.get_book_points_sam3_refined_sam2_width import run_capture_and_pca_sam3_refined_sam2_width as run_capture_and_pca
