...
def bookshelf_barcode_sequence(barcode_number_input: str, shot_dir: Path):  
    ...
    try:
        color_frame = capture_one_depstech(shot_dir / "bookshelf_barcode_capture.png") #画像をキャプチャ
...
if __name__ == "__main__":
    ...
    a = bookshelf_barcode_sequence(barcode_number, shot_dir)
    print(a)